...
> **⚠️ 本文已过时（v1.0 / 100×100×100 立方壳），勿按本文引脚与外壳尺寸施工。**  
> **现行标准请以以下文件为准：**
> - 引脚：[`firmware/include/pins.h`](../firmware/include/pins.h)
> - 接线：[`WIRING.md`](WIRING.md) / [`给店家-接线说明.txt`](给店家-接线说明.txt)
> - 外壳 v7.36（**76×110×58 mm**）：[`case/PRINT.md`](case/PRINT.md) / [`case/COMPONENTS.md`](case/COMPONENTS.md)
> - 生成脚本：`case/generate_case.py`（不是旧的 `generate_enclosure.py`）
>
> 下文仅作电源/安全/组装流程参考；引脚表与外壳章节如有冲突，**一律以上述现行文件为准**。

> **版本**：v1.0（归档）  
> **适用方案（已废弃）**：方案 A（100×100×100 mm 立方体外壳）  
> **现行主控**：YD-ESP32-S3 N16R8  
